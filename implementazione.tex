...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.7]{Implementazione/leaflet.png}
...
\newpage
\subsection{L'algoritmo di Santiago}
...
Vediamo quindi il codice \textit{Javascript} utilizzato per implementare l'algoritmo di Santiago. La prima funzione si occupa di calcolare il sistema e quindi la posizione all'interno di esso.
\begin{lstlisting} [language=JavaScript]
